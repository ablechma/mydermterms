...
const CONDITIONS = [
  ...
  {
    id: "tinea-corporis", conditionName: "Tinea Corporis (Ringworm)", commonName: "Ringworm",
  ...
  {
    id: "dfsp", conditionName: "Dermatofibrosarcoma Protuberans (DFSP)", commonName: "DFSP",
    description: "Dermatofibrosarcoma protuberans (DFSP) is a rare, slow-growing soft tissue sarcoma that develops in the deep layers of the skin. It typically presents as a firm, painless plaque or nodule that gradually enlarges over months to years. While it rarely metastasizes, DFSP is locally aggressive and has a high recurrence rate if not completely excised.",
    symptoms: ["Firm, painless, skin-colored or reddish-brown plaque or nodule","Slow growth over months to years, often initially flat before becoming raised","Rubbery or hard texture on palpation","May develop multiple nodules or protuberant masses over time","Usually 1-5 cm at diagnosis but can grow much larger if untreated","Overlying skin may appear stretched, shiny, or discolored"],
    careInstructions: ["Seek evaluation by a dermatologist or surgical oncologist for any firm, slowly growing skin nodule.","Mohs micrographic surgery is the preferred treatment for complete margin control.","Wide local excision with adequate margins is an alternative when Mohs surgery is not available.","Regular follow-up with imaging and clinical exams is essential due to risk of local recurrence.","Genetic testing may reveal the COL1A1-PDGFB fusion gene characteristic of DFSP.","Imatinib (a targeted therapy) may be used for unresectable or metastatic cases."],
    affectedAreas: ["Trunk (most common)","Arms","Legs","Head and neck"], prevalence: "Rare; approximately 1,000 new cases per year in the United States",
  },
  {
    id: "merkel-cell-carcinoma", conditionName: "Merkel Cell Carcinoma", commonName: "Merkel Cell Carcinoma",
    ...
    symptoms: ["Rapidly growing, firm, painless, dome-shaped nodule","Red, pink, blue, or violet coloration","Shiny, smooth surface that may ulcerate","Typically less than 2 cm at diagnosis but can grow quickly","Most often appears on sun-exposed areas in elderly patients","Usually solitary; may be mistaken for a cyst or benign growth"],
    careInstructions: ["Seek immediate evaluation by a dermatologist for any rapidly growing skin nodule.","Biopsy and immunohistochemical staining are essential for accurate diagnosis.","Wide local excision or Mohs surgery with sentinel lymph node biopsy is standard treatment.","Radiation therapy is often recommended as adjuvant treatment.","Immunotherapy (such as avelumab or pembrolizumab) may be used for advanced or metastatic MCC.","Frequent follow-up with clinical exams and imaging is critical due to high recurrence risk."],
    affectedAreas: ["Head and neck (most common)","Arms","Legs","Trunk"], prevalence: "Rare; approximately 3,000 new cases per year in the United States",
  },
  {
    id: "acne-keloidalis-nuchae", conditionName: "Acne Keloidalis Nuchae", commonName: "Acne Keloidalis Nuchae",
    description: "Acne keloidalis nuchae (AKN) is a chronic inflammatory condition that causes firm, keloid-like papules, pustules, and plaques on the back of the neck and occipital scalp. Despite its name, it is not true acne and is not related to keloid formation. It is most common in men of African descent and is thought to be related to hair follicle irritation and inflammation.",
    symptoms: ["Firm, dome-shaped papules and pustules on the nape of the neck","Keloid-like, raised, thickened plaques that may merge together","Itching, tenderness, or pain in the affected area","Scarring alopecia (permanent hair loss) in affected areas","May develop draining sinuses or abscesses in severe cases","Lesions may be skin-colored, pink, or hyperpigmented"],
    careInstructions: ["Avoid close shaving, tight collars, and friction on the back of the neck.","See a dermatologist early for treatment to prevent scarring and progression.","Topical or intralesional corticosteroids can reduce inflammation.","Topical or oral antibiotics may be prescribed for active pustules.","Laser hair removal can help prevent recurrence in early-stage disease.","Surgical excision may be necessary for large, fibrotic plaques."],
    affectedAreas: ["Nape of the neck","Occipital scalp","Posterior hairline"], prevalence: "Common in men of African descent; affects up to 13% of this population",
  },
  {
    id: "bedbugs", conditionName: "Bedbugs (Cimicosis)", commonName: "Bedbug Bites",
    description: "Bedbug bites are caused by Cimex lectularius, small parasitic insects that feed on human blood, typically at night. The bites produce itchy, red welts that often appear in clusters or linear patterns (\"breakfast, lunch, and dinner\" pattern). Bedbugs do not transmit diseases but can cause significant discomfort, secondary infection from scratching, and psychological distress.",
    symptoms: ["Itchy, red, raised welts or papules on exposed skin","Bites often in clusters or linear rows of 3 or more","Commonly found on arms, legs, face, and neck","Delayed reaction — bites may not appear until days after exposure","Central punctum (bite mark) may be visible","Secondary excoriation and infection from scratching"],
    careInstructions: ["Wash bites gently with soap and water to reduce infection risk.","Apply over-the-counter hydrocortisone cream or calamine lotion to relieve itching.","Take oral antihistamines for significant itching.","Avoid scratching to prevent secondary bacterial infection.","Professional pest extermination is essential to eliminate the infestation.","Wash all bedding and clothing in hot water and dry on high heat; inspect and treat mattresses and furniture."],
    affectedAreas: ["Arms","Legs","Face","Neck","Hands","Any exposed skin during sleep"], prevalence: "Increasingly common worldwide; infestations have risen significantly in urban areas over the past two decades",
  },
  {
    id: "ccca", conditionName: "Central Centrifugal Cicatricial Alopecia (CCCA)", commonName: "CCCA",
    description: "Central centrifugal cicatricial alopecia (CCCA) is a form of scarring hair loss that begins at the crown or vertex of the scalp and spreads outward in a centrifugal pattern. It is the most common cause of scarring alopecia in women of African descent. The condition destroys hair follicles and replaces them with scar tissue, resulting in permanent hair loss if not treated early.",
    symptoms: ["Progressive hair thinning and loss starting at the crown of the scalp","Gradual centrifugal (outward) spread of hair loss","Scalp may appear shiny or smooth in affected areas","Tenderness, itching, or burning sensation on the scalp","Loss of follicular ostia (follicle openings) visible on close examination","Breakage of remaining hairs at the margins of affected area"],
    careInstructions: ["See a dermatologist early — treatment is most effective before extensive scarring occurs.","Avoid or minimize chemical relaxers, tight hairstyles, and excessive heat styling.","Anti-inflammatory treatments including topical or intralesional corticosteroids can slow progression.","Oral antibiotics with anti-inflammatory properties (such as doxycycline) may be prescribed.","Topical minoxidil may help maintain existing hair in unaffected areas.","A scalp biopsy may be recommended to confirm the diagnosis."],
    affectedAreas: ["Crown of the scalp","Vertex","Central scalp expanding outward"], prevalence: "Most common scarring alopecia in women of African descent; estimated prevalence of 2-5%",
  },
  {
    id: "ctcl", conditionName: "Cutaneous T-Cell Lymphoma (CTCL)", commonName: "CTCL",
    description: "Cutaneous T-cell lymphoma (CTCL) is a group of non-Hodgkin lymphomas that primarily affect the skin. The most common subtype is mycosis fungoides, which typically presents as persistent, scaly patches or plaques that may resemble eczema or psoriasis. CTCL progresses slowly over years and can be difficult to diagnose in early stages.",
    symptoms: ["Persistent, scaly, red or pink patches that do not respond to typical eczema treatments","Flat patches may progress to thickened, raised plaques","May develop tumors or nodules in advanced stages","Intense itching is common","Patches often occur in sun-protected areas (buttocks, trunk, inner arms)","Skin may become generally red and inflamed in advanced disease (erythroderma)"],
    careInstructions: ["See a dermatologist if you have persistent, treatment-resistant patches or plaques.","Multiple skin biopsies may be needed over time to confirm the diagnosis.","Early-stage treatment includes topical corticosteroids, phototherapy (UVB or PUVA), and topical nitrogen mustard.","Monitoring with regular dermatology visits is essential as the disease can progress slowly.","Advanced stages may require systemic therapies including retinoids, interferon, or targeted agents.","A multidisciplinary team including dermatology and oncology is recommended for management."],
    affectedAreas: ["Trunk","Buttocks","Inner arms","Thighs","Sun-protected areas"], prevalence: "Rare; approximately 3,000 new cases per year in the United States",
  },
  {
    id: "epidermolysis-bullosa", conditionName: "Epidermolysis Bullosa", commonName: "Epidermolysis Bullosa (Butterfly Skin)",
    ...
    symptoms: ["Skin blisters easily from minor friction, rubbing, or trauma","Blisters may be widespread or localized depending on subtype","Erosions, crusting, and slow-healing wounds","Scarring and milia (small white cysts) at healed blister sites","Nail dystrophy or nail loss","Mucous membranes (mouth, esophagus) may also be affected"],
    careInstructions: ["Handle skin very gently to minimize friction and trauma.","Use non-adherent wound dressings and gentle bandaging techniques.","Keep blisters clean and lance large blisters with a sterile needle to prevent extension.","Maintain wound care with appropriate topical antibiotics to prevent infection.","Work with a specialized EB care team including dermatology, wound care, and nutrition.","Genetic counseling is recommended for affected families."],
    affectedAreas: ["Hands","Feet","Knees","Elbows","Trunk","Mucous membranes"], prevalence: "Rare; estimated 1 in 20,000 live births worldwide",
  },
  {
    id: "frontal-fibrosing-alopecia", conditionName: "Frontal Fibrosing Alopecia", commonName: "Frontal Fibrosing Alopecia",
    description: "Frontal fibrosing alopecia (FFA) is a form of scarring (cicatricial) alopecia characterized by progressive recession of the frontal and temporal hairline. It primarily affects postmenopausal women and is considered a variant of lichen planopilaris. The condition destroys hair follicles permanently, so early treatment is important to slow progression.",
    symptoms: ["Progressive, symmetric recession of the frontal and temporal hairline","Loss of eyebrows (often an early sign) and eyelashes","Pale, smooth, scarred skin where hair has been lost","Perifollicular redness or scaling at the active margin of hair loss","Lonely hairs — isolated hairs remaining within the area of loss","Facial papules may occur along the hairline"],
    careInstructions: ["See a dermatologist early for evaluation and treatment to slow progression.","Topical or intralesional corticosteroids can reduce inflammation at the active border.","Hydroxychloroquine or other immunomodulators may be prescribed to slow the disease.","5-alpha reductase inhibitors (finasteride or dutasteride) may help stabilize hair loss.","Avoid traction on the hairline from tight hairstyles.","A scalp biopsy may be performed to confirm the diagnosis."],
    affectedAreas: ["Frontal hairline","Temporal hairline","Eyebrows","Eyelashes","Body hair"], prevalence: "Increasingly recognized; predominantly affects postmenopausal women, though premenopausal women and men can be affected",
  },
  {
    id: "hand-foot-mouth-disease", conditionName: "Hand-Foot-and-Mouth Disease", commonName: "Hand-Foot-and-Mouth Disease",
    description: "Hand-foot-and-mouth disease (HFMD) is a common, contagious viral illness caused most often by coxsackievirus A16 or enterovirus 71. It primarily affects infants and young children but can occur in adults. The disease is characterized by fever, painful mouth sores, and a rash with blisters on the hands and feet.",
    symptoms: ["Fever, sore throat, and malaise as initial symptoms","Painful red spots or blisters inside the mouth, on the tongue, and gums","Red spots, blisters, or papules on the palms, soles, and fingers","Rash may also appear on the buttocks, knees, and elbows","Mouth sores may cause difficulty eating and drinking","Symptoms typically resolve within 7-10 days"],
    careInstructions: ["Manage fever and pain with acetaminophen or ibuprofen as appropriate for age.","Encourage fluids to prevent dehydration, especially if mouth sores make eating painful.","Offer soft, cool foods and avoid acidic or spicy items that irritate mouth sores.","Practice good hand hygiene and disinfect shared surfaces to reduce spread.","Keep affected children home from school or daycare until fever resolves and blisters dry.","See a doctor if the child cannot drink fluids, symptoms worsen, or fever persists beyond 3 days."],
    affectedAreas: ["Mouth (tongue, gums, inner cheeks)","Palms","Soles","Fingers","Buttocks"], prevalence: "Very common in children under 5; outbreaks occur frequently in childcare settings",
  },
  {
    id: "ichthyosis-vulgaris", conditionName: "Ichthyosis Vulgaris", commonName: "Fish Scale Disease",
    description: "Ichthyosis vulgaris is the most common inherited disorder of keratinization, caused by mutations in the filaggrin gene. It presents with dry, scaly skin that resembles fish scales, typically appearing in early childhood. The condition is lifelong but can be managed effectively with consistent moisturizing and skin care.",
    symptoms: ["Dry, scaly skin with fine, white-to-gray polygonal scales","Scales most prominent on the shins, arms, and trunk","Hyperlinear palms (exaggerated skin lines on the palms)","Often associated with keratosis pilaris (rough bumps on upper arms)","Symptoms worsen in cold, dry weather and improve in warm, humid conditions","May be associated with atopic dermatitis (eczema) and allergies"],
    careInstructions: ["Apply thick, fragrance-free moisturizers or emollients immediately after bathing.","Use gentle, soap-free cleansers to avoid stripping natural skin oils.","Keratolytic agents containing urea (10-40%), lactic acid, or salicylic acid can help reduce scaling.","Take lukewarm baths and add bath oils to hydrate the skin.","Use a humidifier during dry winter months.","See a dermatologist for prescription-strength treatments if over-the-counter products are insufficient."],
    affectedAreas: ["Shins","Arms","Trunk","Palms (hyperlinear)","Back","Thighs"], prevalence: "Common; affects approximately 1 in 250 people",
  },
  {
    id: "erythema-migrans", conditionName: "Erythema Chronicum Migrans (Lyme Disease)", commonName: "Lyme Disease Rash / Bull's-Eye Rash",
    description: "Erythema chronicum migrans (ECM) is the characteristic skin rash of early Lyme disease, caused by the spirochete Borrelia burgdorferi transmitted through the bite of an infected Ixodes (deer) tick. The rash typically appears as an expanding red patch, often with central clearing that creates a bull's-eye or target-like pattern. It is the hallmark sign of Lyme disease and an important clinical clue for early diagnosis and treatment.",
    symptoms: ["Expanding red or pink patch at the site of a tick bite","Classic bull's-eye or target pattern with central clearing (not always present)","Rash typically appears 3-30 days after the tick bite","Gradually enlarges over days to weeks, often reaching 12 inches or more","Usually painless but may feel warm to the touch; mild itching possible","May be accompanied by fever, fatigue, headache, and muscle or joint aches"],
    careInstructions: ["See a healthcare provider promptly if you develop an expanding rash after a tick bite.","Early treatment with oral antibiotics (typically doxycycline) is highly effective.","Complete the full course of prescribed antibiotics even if symptoms improve.","Check for ticks after spending time outdoors in endemic areas.","Use insect repellent containing DEET and wear protective clothing in wooded or grassy areas.","Remove attached ticks promptly with fine-tipped tweezers, grasping close to the skin."],
    affectedAreas: ["Site of tick bite (anywhere on body)","Trunk","Thighs","Groin","Axillae (armpits)"], prevalence: "Common in endemic areas; approximately 476,000 cases of Lyme disease are diagnosed annually in the United States",
  },
  {
    id: "nummular-dermatitis", conditionName: "Nummular Dermatitis", commonName: "Nummular Eczema / Discoid Eczema",
    ...
    symptoms: ["Round or oval, coin-shaped plaques of eczema","Well-defined borders with red, scaly, or crusted surface","Intensely itchy, especially at night","Lesions may weep, ooze, or become secondarily infected","Typically 1-10 cm in diameter","May occur as single or multiple lesions"],
    careInstructions: ["Moisturize frequently with thick, fragrance-free creams or ointments.","Apply prescribed topical corticosteroids to active lesions.","Avoid known irritants including harsh soaps, wool, and dry environments.","Take lukewarm baths and apply moisturizer immediately after.","See a dermatologist if lesions do not respond to treatment or become infected.","Oral antibiotics may be needed if secondary bacterial infection develops."],
    affectedAreas: ["Legs (most common)","Arms","Trunk","Hands","Feet"], prevalence: "Moderately common; more frequent in men, with peak incidence between ages 55-65",
  },
  {
    id: "sebaceous-carcinoma", conditionName: "Sebaceous Carcinoma", commonName: "Sebaceous Gland Carcinoma",
    description: "Sebaceous carcinoma is a rare, aggressive malignant tumor arising from the sebaceous (oil) glands of the skin. It most commonly occurs on the eyelid, where it can mimic benign conditions such as chalazion or blepharitis, leading to delayed diagnosis. It can also occur on the head, neck, and trunk. Early detection is critical as it has the potential to metastasize.",
    symptoms: ["Firm, painless, slowly growing nodule, most often on the upper eyelid","Yellow or skin-colored papule or nodule that may resemble a chalazion or stye","Loss of eyelashes in the area of the tumor (madarosis)","Unilateral, chronic, treatment-resistant blepharitis or conjunctivitis","Thickening of the eyelid or a mass that recurs after excision","Extraocular lesions present as pink or yellowish nodules on the head, neck, or trunk"],
    careInstructions: ["See an ophthalmologist or dermatologist promptly for any persistent eyelid nodule that does not respond to treatment.","Biopsy with special staining (Oil Red O on fresh tissue) is essential for diagnosis.","Mohs micrographic surgery or wide local excision is the preferred treatment.","Sentinel lymph node biopsy may be recommended to assess for metastasis.","Regular follow-up with clinical exams is critical due to risk of recurrence and metastasis.","Consider screening for Muir-Torre syndrome if sebaceous carcinoma occurs with other internal malignancies."],
    affectedAreas: ["Upper eyelid (most common)","Lower eyelid","Head","Neck","Trunk"], prevalence: "Rare; accounts for approximately 1-5% of eyelid malignancies",
  },
  {
    id: "pemphigus-vulgaris", conditionName: "Pemphigus Vulgaris", commonName: "Pemphigus Vulgaris",
    description: "Pemphigus vulgaris is a rare, serious autoimmune blistering disease in which the immune system produces antibodies against desmoglein proteins that hold skin cells together. This causes painful, flaccid blisters and erosions on the skin and mucous membranes. Without treatment, pemphigus vulgaris can be life-threatening due to widespread skin loss and secondary infection.",
    symptoms: ["Painful oral erosions and ulcers, often the first sign","Flaccid, fragile blisters on the skin that rupture easily","Nikolsky sign positive — gentle lateral pressure causes skin to shear off","Widespread, painful erosions and crusting where blisters have ruptured","Blisters arise on normal-appearing skin without surrounding redness","May affect other mucous membranes including throat, nose, and genitals"],
    careInstructions: ["Seek urgent evaluation by a dermatologist for persistent oral ulcers or unexplained blistering.","Systemic corticosteroids are typically the first-line treatment to control the disease.","Steroid-sparing immunosuppressants (such as mycophenolate or azathioprine) are usually added.","Rituximab has become an important treatment option for moderate-to-severe disease.","Wound care for open erosions is essential to prevent secondary infection.","Regular monitoring of blood counts, liver function, and infection risk during immunosuppressive therapy."],
    affectedAreas: ["Oral mucosa (most common initial site)","Trunk","Scalp","Face","Groin","Any skin surface"], prevalence: "Rare; approximately 1-5 cases per million people per year",
  },
  {
    id: "prurigo-nodularis", conditionName: "Prurigo Nodularis", commonName: "Prurigo Nodularis",
    ...
    symptoms: ["Multiple firm, dome-shaped nodules on the skin","Intense, often unbearable itching","Nodules typically 1-3 cm in diameter, hard and well-defined","Hyperpigmented or skin-colored with a rough, excoriated surface","Distributed symmetrically on arms, legs, and trunk","Central back often spared (butterfly sign — areas the patient cannot reach)"],
    careInstructions: ["See a dermatologist for evaluation and to rule out underlying systemic causes of itching.","Break the itch-scratch cycle with potent topical corticosteroids or topical calcineurin inhibitors.","Intralesional corticosteroid injections can flatten individual nodules.","Oral medications such as gabapentin, pregabalin, or dupilumab may be prescribed for itch control.","Keep nails trimmed short and consider wearing cotton gloves at night.","Phototherapy (narrowband UVB) may be effective for widespread disease."],
    affectedAreas: ["Arms","Legs","Trunk","Upper back","Buttocks"], prevalence: "Uncommon but increasingly recognized; more common in middle-aged and older adults",
  },
  {
    id: "poison-ivy", conditionName: "Poison Ivy (Toxicodendron Dermatitis)", commonName: "Poison Ivy Rash",
    description: "Poison ivy dermatitis is an allergic contact dermatitis caused by urushiol, an oily resin found in poison ivy, poison oak, and poison sumac plants. It is the most common cause of allergic contact dermatitis in North America. The rash typically appears 12-72 hours after exposure and is characterized by intensely itchy, red, streaky blisters.",
    symptoms: ["Intensely itchy, red, streaky rash in linear or irregular patterns","Blisters (vesicles and bullae) that may weep clear fluid","Swelling and redness in the area of contact","Rash often appears in streaks or lines corresponding to plant contact","New areas may appear over several days (not from spreading fluid, but delayed absorption)","Severe reactions may involve facial swelling or widespread blistering"],
    careInstructions: ["Wash all exposed skin, clothing, tools, and pets with soap and water as soon as possible after exposure.","Apply cool compresses and calamine lotion to soothe itching.","Over-the-counter hydrocortisone cream and oral antihistamines can help mild cases.","See a doctor for severe reactions — oral corticosteroids (typically a 2-3 week taper) may be needed.","Do not pop blisters; blister fluid does not spread the rash.","Learn to identify and avoid poison ivy, oak, and sumac plants (\"Leaves of three, let it be\")."],
    affectedAreas: ["Hands","Arms","Legs","Face","Any exposed skin"], prevalence: "Very common; approximately 50-75% of the U.S. population is sensitized to urushiol",
  },
  {
    id: "scleroderma", conditionName: "Scleroderma", commonName: "Scleroderma (Systemic Sclerosis)",
    description: "Scleroderma is a chronic autoimmune connective tissue disease characterized by hardening and tightening of the skin and connective tissues. It ranges from localized forms (morphea, linear scleroderma) affecting only the skin to systemic sclerosis, which can involve the skin, blood vessels, and internal organs including the lungs, kidneys, heart, and gastrointestinal tract.",
    symptoms: ["Thickened, hardened, tight skin, often starting on the fingers and hands","Raynaud's phenomenon — fingers turning white, blue, then red in response to cold","Swollen, puffy fingers (sclerodactyly) with limited range of motion","Skin may appear shiny and smooth with loss of normal creases","Telangiectasias (small red spots from dilated blood vessels) on the face and hands","Calcinosis (calcium deposits under the skin) in some patients"],
    careInstructions: ["See a rheumatologist and dermatologist for comprehensive evaluation and management.","Protect hands from cold exposure and use warming gloves to manage Raynaud's phenomenon.","Moisturize skin frequently to help manage tightness and dryness.","Physical therapy and gentle stretching exercises can help maintain joint mobility.","Medications may include immunosuppressants, vasodilators, and antifibrotic agents depending on organ involvement.","Regular monitoring of lung function, kidney function, and blood pressure is essential."],
    affectedAreas: ["Fingers and hands","Face","Arms","Trunk","Feet","Internal organs (lungs, kidneys, GI tract in systemic form)"], prevalence: "Rare; approximately 75,000-100,000 people in the United States",
  },
  {
    id: "xeroderma-pigmentosum", conditionName: "Xeroderma Pigmentosum", commonName: "XP (Children of the Moon)",
    description: "Xeroderma pigmentosum (XP) is a rare, inherited genetic disorder caused by defects in the DNA repair mechanism that fixes ultraviolet (UV) radiation damage. Affected individuals are extremely sensitive to sunlight and have a dramatically increased risk of developing skin cancers at a very young age. Strict sun protection from birth is the cornerstone of management.",
    symptoms: ["Severe sunburn with blistering after minimal sun exposure, often noted in infancy","Numerous freckle-like spots (lentigines) appearing in sun-exposed areas before age 2","Dry, parchment-like skin (xerosis) in sun-exposed areas","Very early onset of skin cancers (basal cell, squamous cell, melanoma) — often before age 10","Progressive photodamage with telangiectasias, atrophy, and irregular pigmentation","Eye problems including photophobia, conjunctival inflammation, and corneal damage"],
    careInstructions: ["Strict, lifelong UV protection is essential: avoid all sun exposure and UV light sources.","Wear UV-protective clothing, broad-brimmed hats, UV-blocking glasses, and UV-filtering window film.","Apply broad-spectrum SPF 50+ sunscreen to all exposed skin, reapplying frequently.","Regular skin exams (every 3-6 months) with a dermatologist for early detection and treatment of skin cancers.","Regular ophthalmologic exams to monitor for UV-related eye damage.","Genetic counseling for families; XP is inherited in an autosomal recessive pattern."],
    affectedAreas: ["Face","Neck","Arms","Hands","Any sun-exposed skin","Eyes"], prevalence: "Very rare; approximately 1 in 250,000 people in the United States",
  },
];

var CATEGORIES = [
  { label: "All Conditions", filter: null },
  { label: "Non-Cancerous Lesions", filter: ["seborrheic-keratosis","lichenoid-keratosis","porokeratosis","cherry-angioma","lentigo","dermatofibroma","warts","melanocytic-nevus","atypical-nevus","sebaceous-hyperplasia","epidermal-inclusion-cyst","pilar-cyst","molluscum-contagiosum","pilomatrixoma","milium-cyst","angiokeratoma","actinic-purpura","acrochordon","cafe-au-lait","blue-nevus","lipoma","ephelis","keloid","pyogenic-granuloma","spider-angioma","telangiectasia"] },
  { label: "Cancerous Lesions", filter: ["actinic-keratosis","basal-cell-carcinoma","squamous-cell-carcinoma","melanoma","scc-in-situ","dfsp","merkel-cell-carcinoma","ctcl","sebaceous-carcinoma"] },
  { label: "Rashes", filter: ["eczema","psoriasis","seborrheic-dermatitis","acne","rosacea","periorificial-dermatitis","hidradenitis-suppurativa","vitiligo","melasma","granuloma-annulare","contact-dermatitis","lichen-planus","acne-necrotica-miliaris","discoid-lupus","tinea-versicolor","tinea-corporis","onychomycosis","alopecia-areata","urticaria","hyperhidrosis","herpes-zoster","bullous-pemphigoid","erysipelas","abscess","carbuncle","acanthosis-nigricans","erythema-multiforme","erythema-nodosum","erythrasma","angioedema","cold-sore","folliculitis","impetigo","keratosis-pilaris","lichen-simplex-chronicus","paronychia","pityriasis-rosea","scabies","xerosis","acne-keloidalis-nuchae","bedbugs","ccca","epidermolysis-bullosa","frontal-fibrosing-alopecia","hand-foot-mouth-disease","ichthyosis-vulgaris","erythema-migrans","nummular-dermatitis","pemphigus-vulgaris","prurigo-nodularis","poison-ivy","scleroderma","xeroderma-pigmentosum"] },
...
var CONDITION_COLORS = {
  ...
  "dfsp": "#B71C1C", "merkel-cell-carcinoma": "#880E4F",
  "acne-keloidalis-nuchae": "#5D4037", "bedbugs": "#6D4C41", "ccca": "#4E342E",
  "ctcl": "#9C27B0", "epidermolysis-bullosa": "#EF5350", "frontal-fibrosing-alopecia": "#7B1FA2",
  "hand-foot-mouth-disease": "#F4511E", "ichthyosis-vulgaris": "#78909C",
  "erythema-migrans": "#2E7D32", "nummular-dermatitis": "#FF8F00",
  "sebaceous-carcinoma": "#B71C1C", "pemphigus-vulgaris": "#D50000", "prurigo-nodularis": "#6D4C41",
  "poison-ivy": "#33691E", "scleroderma": "#37474F", "xeroderma-pigmentosum": "#4A148C",
};
